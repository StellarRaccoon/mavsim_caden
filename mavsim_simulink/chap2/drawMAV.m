function drawSpacecraft(uu)
    ...
    if t==0
        ...
        mav_handle = drawMavBody(Vertices,Faces,facecolors,pn,pe,pd,phi,theta,psi,[]);
        title('MAV')
        xlabel('East')
        ylabel('North')
        zlabel('-Down')
    ...
    % at every other time step, redraw base and rod
        ...
        drawMavBody(Vertices,Faces,facecolors,pn,pe,pd,phi,theta,psi,mav_handle);
    end
end
...
%=======================================================================
%
function handle = drawMavtBody(V,F,patchcolors,...
